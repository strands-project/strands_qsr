#!/usr/bin/env python
import roslib; roslib.load_manifest('strands_qsr_echo_classifier')
...
def handle_group_classification(req):
    ...
    res.group_classification = req.group_classification
...
def echo_classification_server():
    rospy.init_node('echo_classification_server')
